        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Midterm = table.Column<double>(type: "double precision", nullable: false),
                    Final = table.Column<double>(type: "double precision", nullable: false),
                    Homework = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Grades",
                columns: new[] { "Id", "CourseId", "Final", "Homework", "Midterm", "StudentId" },
                values: new object[,]
                {
                    { 1, 1, 30.0, 40.0, 20.0, 1 },
                    { 2, 2, 20.0, 50.0, 52.0, 2 },
                    { 3, 3, 99.0, 60.0, 30.0, 3 }
                });
